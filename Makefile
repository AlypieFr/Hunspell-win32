...
ACLOCAL = ${SHELL} /c/hunspell-1.3.3/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
AR = ar
AS = as
AUTOCONF = ${SHELL} /c/hunspell-1.3.3/missing --run autoconf
AUTOHEADER = ${SHELL} /c/hunspell-1.3.3/missing --run autoheader
AUTOMAKE = ${SHELL} /c/hunspell-1.3.3/missing --run automake-1.11
AWK = gawk
...
INTL_MACOSX_LIBS = 
LD = c:/Strawberry/c/x86_64-w64-mingw32/bin/ld.exe
LDFLAGS = 
LIBICONV = -liconv
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /c/hunspell-1.3.3/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MSGFMT = :
MSGFMT_015 = :
MSGMERGE = :
NM = /c/Strawberry/c/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
abs_builddir = /c/hunspell-1.3.3
abs_srcdir = /c/hunspell-1.3.3
abs_top_builddir = /c/hunspell-1.3.3
abs_top_srcdir = /c/hunspell-1.3.3
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /c/hunspell-1.3.3/install-sh
